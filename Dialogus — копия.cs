...
namespace ttc_wtc
{
     class BasicDialogBuilder 
    {
        ...
        public static BasicDialogBuilder UminekoAfterWinDialogBuilder = new BasicDialogBuilder("Спасибо,теперь все будет как прежде", "Если бы не ты я бы проиграл", "Когда мы вернемся в свои тела?", "Через пару дней мы вернемся в свои тела и все будет хорошо");
    }
